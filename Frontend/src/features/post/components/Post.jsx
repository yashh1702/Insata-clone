        ...
        <div className="post">
            <div className="user">
                <div className="img-wrapper">
                    <img src="https://images.unsplash.com/photo-1774274998796-978b79613657?q=80&w=1025&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                </div>
                <p>Username</p>
            </div>
            <img src="https://images.unsplash.com/photo-1774274998796-978b79613657?q=80&w=1025&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            ...
            <div className="bottom">
                <div className="caption">Caption Username_1</div>
            </div>
        </div>
    )
}
